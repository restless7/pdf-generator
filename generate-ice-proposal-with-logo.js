...
async function generateICEProposalPDF() {
  ...
  try {
    console.log('📄 Starting ICE Proposal PDF generation with embedded logo...');
    ...
    const logoBase64 = fs.readFileSync(path.join(__dirname, 'logominimalapex.png')).toString('base64');
    
    // Replace the logo reference with base64 embedded image
    htmlContent = htmlContent.replace(
      '<img src="logominimalapex.png" alt="APEX AI Solutions" class="logo">',
      `<img src="data:image/png;base64,${logoBase64}" alt="APEX AI Solutions" class="logo">`
    );
...
// Run the generator
console.log('🚀 ICE Proposal PDF Generator with Embedded Logo v1.0');
console.log('=====================================================');
